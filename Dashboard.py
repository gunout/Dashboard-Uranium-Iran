...
n_months = len(date_range)  # 38 mois
...
with col_badges4:
    st.markdown(f"<span class='critical-badge'>💣 {LATEST_IAEA_DATA['weapons_potential']} bombes potentielles</span>", unsafe_allow_html=True)
with col_badges5:
    st.markdown(f"<span class='warning-badge'>🕒 Breakout: {LATEST_IAEA_DATA['thresholds']['breakout_time']} jours</span>", unsafe_allow_html=True)
...
if menu == "📊 Tableau de bord principal":
    ...
    # Marqueur pour les frappes - CORRIGÉ
    fig.add_vline(
        x=datetime(2025, 6, 15),
        line_dash="dash",
        line_color="#DA0000",
        line_width=2,
        row=2, col=1
    ...
    fig.add_annotation(
        x=datetime(2025, 6, 15),
        y=INSPECTION_HISTORY['access_level'].max() * 0.9,
        text="Frappes juin 2025",
        showarrow=True,
        arrowhead=1,
        ax=0,
        ay=-40,
    ...
    <div class='critical-box'>
        ...
        si l'uranium à 60% est toujours présent ou a été déplacé.</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col_dip2:
        ...
        <div style='background-color: #fff3cd; padding: 1rem; border-radius: 0.5rem; margin: 0.5rem 0;'>
            ...
            Demande américaine: Démantèlement de l'infrastructure nucléaire
        </div>
        """, unsafe_allow_html=True)
    ...
    with col_act1:
        ...
        <div class='facility-card'>
            <h4>🇮🇷 Iran</h4>
            <p><b>Position:</b> Programme pacifique, droit à l'enrichissement</p>
            <p><b>Ligne rouge:</b> Armes nucléaires "inacceptables"</p>
            <p><b>Concession possible:</b> Dilution du stock</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col_act2:
        ...
        <div class='facility-card'>
            <h4>🇺🇸 États-Unis</h4>
            <p><b>Position:</b> Démantèlement complet</p>
            <p><b>Preuves:</b> Reconstruction du programme d'armes</p>
    ...
    with col_act4:
        ...
        <div class='facility-card'>
            ...
            <p><b>Proposition:</b> Dilution de l'uranium</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with tab_scen1:
        ...
        **Accord diplomatique** (probabilité: 30%)
        ...
        - Iran accepte de diluer son stock d'uranium à 60%
    ...
    with col_news2:
        ...
        **Titres récents:**
        ...
        - **Gulf Times:** L'AIEA demande l'accès aux sites d'Ispahan
        - **ISW:** L'AIEA ne peut vérifier la suspension de l'enrichissement
        - **Al Jazeera:** Stock d'uranium hautement enrichi sous terre à Ispahan
        - **Jerusalem Post:** Première confirmation de la localisation de l'uranium à 60%
    ...
    with tab_scen_det1:
        ...
        **Évolution:**
        - Activité non vérifiée se poursuit sur les sites
        - Véhicules continuent de circuler autour d'Ispahan
    ...
    with tab_scen_det2:
        ...
        **Termes possibles:**
        - Dilution du stock d'uranium à 60% au niveau le plus bas possible
        ...
        **Calendrier:**
        - Mars 2026: Réunions techniques à Vienne
    ...
    with tab_scen_det3:
        ...
        **Cibles prioritaires:**
        1. Complexe souterrain d'Ispahan
...
with col_footer2:
    ...
    <div class='info-box'>
        <b>📅 Mise à jour</b><br>
        • Dernier rapport AIEA: 27 février 2026<br>
